#==================================================================================================#
# This is the master function for robust subset selection with local combinatorial search. It calls heuristics and mio.
#==================================================================================================#

#' @title Robust subset selection with local combinatorial search
#'
#' @author Ryan Thompson <ryan.thompson1@unsw.edu.au>
#' @author Zhan Gao <zhangao@usc.edu>
#'
...
mio_ls <- \(x, y, k, h, l_a, l_b, beta, eta, tau, params, warm.start) {
